...
import floorBanner from 'images/about/floor-banner.png';
import AOS from 'aos';
      ...
      <div className={style.container}>
        ...
        <div className={style.floor_area}>
          ...
          <h3 className={style.floor_title}>
            We want to create a world where all ideas
            <br />
            come true through creativity and innovation
          </h3>
        </div>
      </div>
    </Layouts>
